...
export default function AdvancedAssetManagementApp() {
  ...
  const navigasiUtama = [
    { label: "Dashboard", target: "dashboard", icon: BarChart3 },
    { label: "Aset", target: "aset", icon: Archive },
    { label: "Operasional", target: "operasional", icon: Truck },
    { label: "Maintenance", target: "maintenance", icon: Wrench },
    { label: "Laporan", target: "laporan", icon: FileText },
    { label: "Konfigurasi", target: "konfigurasi", icon: Database },
  ];

  const lompatKeBagian = (target) => {
    const bagian = document.getElementById(target);
    if (bagian) bagian.scrollIntoView({ behavior: "smooth", block: "start" });
  };
    ...
    <div className="min-h-screen bg-slate-100 text-slate-950">
      ...
      <main>
        <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/85 px-5 py-4 backdrop-blur md:px-8">
          ...
          <nav className="mt-4 flex gap-2 overflow-x-auto rounded-2xl border border-slate-200 bg-slate-50 p-2 text-sm font-semibold">
            {navigasiUtama.map(({ label, target, icon: Icon }, index) => (
              <button
                key={target}
                onClick={() => lompatKeBagian(target)}
                className={`flex shrink-0 items-center gap-2 rounded-xl px-4 py-2.5 transition ${index === 0 ? "bg-slate-950 text-white shadow-sm" : "text-slate-600 hover:bg-white hover:text-slate-950"}`}
              >
        ...
        <section className="p-5 md:p-8">
          <div id="konfigurasi" className="scroll-mt-36">
            <SyncPanel
              config={syncConfig}
          ...
          <div id="dashboard" className="scroll-mt-36 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="mt-10 grid gap-5 xl:grid-cols-3">
            <section id="operasional" className="scroll-mt-36 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm xl:col-span-2">
          ...
          <div id="aset" className="mt-10 scroll-mt-36 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div id="maintenance" className="mt-10 scroll-mt-36 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div id="laporan" className="mt-10 scroll-mt-36 grid gap-5 xl:grid-cols-2">
